...
typedef void ((*(ACC_Architecture_driverUserInterface_executeTypedef))(void *,ACCUserMode_t ,double ,bool *));
typedef void ((*(ACC_Architecture_driverUserInterface_updateTypedef))(void *,ACCUserMode_t ,double ));
...
typedef void ((*(ACC_Architecture_ACC_SystemNoEnum_If_executeTypedef))(void *,double ,bool ,double ,double ,double ,double ,double *));
typedef void ((*(ACC_Architecture_ACC_SystemNoEnum_If_updateTypedef))(void *,double ,bool ,double ,double ,double ,double ));
