###########################################################################
## Makefile generated for Simulink model 'Input_Conversion'. 
## 
## Makefile     : Input_Conversion.mk
## Generated on : Tue Mar 26 15:11:17 2019
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: .\Input_Conversion_rtwlib.lib
...
MODELREF_LINK_RSPFILE_NAME = Input_Conversion_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..
MODELREF_LINK_RSPFILE     = Input_Conversion_ref.rsp
...
MODELLIB                  = Input_Conversion_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
PRODUCT = .\Input_Conversion_rtwlib.lib
...
INCLUDES_BUILDINFO = $(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\slprj\autosar\Input_Conversion;C:\WCs\PLRover\CONTRO~1\CONTRO~1\FLOATI~1\03_INP~1;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\autosar\_sharedutils
...
DEFINES_STANDARD = -DMODEL=Input_Conversion -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\slprj\autosar\Input_Conversion\Input_Conversion.c
...
{$(START_DIR)\slprj\autosar\Input_Conversion}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\Input_Conversion}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
