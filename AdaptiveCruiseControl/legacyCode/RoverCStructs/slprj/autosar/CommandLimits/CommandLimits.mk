###########################################################################
## Makefile generated for Simulink model 'CommandLimits'. 
## 
## Makefile     : CommandLimits.mk
## Generated on : Tue Mar 26 15:11:12 2019
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: .\CommandLimits_rtwlib.lib
...
MODELREF_LINK_RSPFILE_NAME = CommandLimits_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..
MODELREF_LINK_RSPFILE     = CommandLimits_ref.rsp
...
MODELLIB                  = CommandLimits_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
PRODUCT = .\CommandLimits_rtwlib.lib
...
INCLUDES_BUILDINFO = $(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\slprj\autosar\CommandLimits;C:\WCs\PLRover\CONTRO~1\CONTRO~1\FLOATI~1\02_LIM~1;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\autosar\_sharedutils
...
DEFINES_STANDARD = -DMODEL=CommandLimits -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\slprj\autosar\CommandLimits\CommandLimits.c
...
{$(START_DIR)\slprj\autosar\CommandLimits}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\CommandLimits}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
