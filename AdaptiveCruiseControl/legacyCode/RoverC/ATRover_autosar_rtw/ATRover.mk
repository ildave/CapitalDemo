###########################################################################
## Makefile generated for Simulink model 'ATRover'. 
## 
## Makefile     : ATRover.mk
## Generated on : Tue Mar 26 15:11:31 2019
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\ATRover.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\WCs\PLRover\ControllersSimulinkProject\generatedCode
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = ATRover_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = ATRover_ref.rsp
GEN_LINKER_RESPONSE       = $(MATLAB_ARCH_BIN)\createResponseFile.exe 1 
CMD_FILE                  = $(PRODUCT_NAME).rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
SHARED_SRC_DIR            = $(START_DIR)\slprj\autosar\_sharedutils
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ATRover.exe
...
INCLUDES_BUILDINFO = .\referenced_model_includes;C:\WCs\PLRover\CONTRO~1\CONTRO~1\FLOATI~1\01_OBS~1;C:\WCs\PLRover\CONTRO~1\CONTRO~1\FLOATI~1\03_INP~1;C:\WCs\PLRover\CONTRO~1\CONTRO~1\FLOATI~1\02_LIM~1;$(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\ATRover_autosar_rtw;C:\WCs\PLRover\ControllersSimulinkProject\AutosarProjects;$(START_DIR)\ATRover_autosar_rtw\stub;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\autosar\_sharedutils
...
DEFINES_STANDARD = -DMODEL=ATRover -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\ATRover_autosar_rtw\ATRover.c $(START_DIR)\ATRover_autosar_rtw\stub\Rte_Rover_NoSF_v1.c
...
OBJS = ATRover.obj Rte_Rover_NoSF_v1.obj
...
MODELREF_LIBS = .\CommandLimits_rtwlib.lib .\Input_Conversion_rtwlib.lib .\Obstacle_Detection_rtwlib.lib
...
{$(START_DIR)\ATRover_autosar_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ATRover_autosar_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ATRover_autosar_rtw\stub}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ATRover_autosar_rtw\stub}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
$(SHARED_LIB) : $(SHARED_SRC)
	$(GEN_ARCHIVER_RESPONSE) ..\slprj\autosar\_sharedutils\rtwshared.rsp $? 
	@cmd /C "@echo ### Compiling shared utility files ..."
	$(CC) $(CFLAGS) -Fo$(SHARED_BIN_DIR)\ @..\slprj\autosar\_sharedutils\rtwshared.rsp
	...
	$(RM) ..\slprj\autosar\_sharedutils\rtwshared.rsp 
