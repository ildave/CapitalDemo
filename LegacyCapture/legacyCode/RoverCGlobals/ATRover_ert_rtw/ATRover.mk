...
## 
## Makefile     : ATRover.mk
## Generated on : Wed Jun 19 09:46:54 2019
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Work\Home\Projekte\1-ESD-PM\ESDR2019.2\30-Realization\10-Development\CToESDArchitecture\GlobalVarsSample\RoverSimulink
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = $(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\ATRover_ert_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
SRCS = $(START_DIR)\ATRover_ert_rtw\ATRover.c $(START_DIR)\ATRover_ert_rtw\ATRover_data.c

MAIN_SRC = $(START_DIR)\ATRover_ert_rtw\ert_main.c
...
OBJS = ATRover.obj ATRover_data.obj
...
{$(START_DIR)\ATRover_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ATRover_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
