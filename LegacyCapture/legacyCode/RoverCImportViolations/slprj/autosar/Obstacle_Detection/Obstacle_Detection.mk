###########################################################################
## Makefile generated for Simulink model 'Obstacle_Detection'. 
## 
## Makefile     : Obstacle_Detection.mk
## Generated on : Tue Mar 26 15:11:22 2019
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: .\Obstacle_Detection_rtwlib.lib
...
PRODUCT_NAME              = Obstacle_Detection
MAKEFILE                  = Obstacle_Detection.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = Obstacle_Detection_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..
MODELREF_LINK_RSPFILE     = Obstacle_Detection_ref.rsp
...
MODELLIB                  = Obstacle_Detection_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
PRODUCT = .\Obstacle_Detection_rtwlib.lib
...
INCLUDES_BUILDINFO = $(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\slprj\autosar\Obstacle_Detection;C:\WCs\PLRover\CONTRO~1\CONTRO~1\FLOATI~1\01_OBS~1;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;$(START_DIR)\slprj\autosar\_sharedutils
...
DEFINES_STANDARD = -DMODEL=Obstacle_Detection -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\slprj\autosar\Obstacle_Detection\Obstacle_Detection.c
...
{$(START_DIR)\slprj\autosar\Obstacle_Detection}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\Obstacle_Detection}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
