...
void Obstacle_Detection(const real_T *rtu_DAQ_In_Sensor_Back_Left, const real_T *
  rtu_DAQ_In_Sensor_Back_Center, const real_T *rtu_DAQ_In_Sensor_Back_Right,
  const real_T *rtu_DAQ_In_Sensor_Front_Left, const real_T
  *rtu_DAQ_In_Sensor_Front_Center, const real_T *rtu_DAQ_In_Sensor_Front_Right,
  const real_T *rtu_DAQ_In_Drive_Direction, const real_T
