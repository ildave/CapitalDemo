function CodeDefine() { 
this.def = new Array();
this.def["Obstacle_Detection_Noturn_Init"] = {file: "Obstacle_Detection_c.html",line:25,type:"fcn"};
this.def["Obstacle_Detection_Noturn"] = {file: "Obstacle_Detection_c.html",line:39,type:"fcn"};
this.def["Obstacle_Detection_Init"] = {file: "Obstacle_Detection_c.html",line:49,type:"fcn"};
this.def["Obstacle_Detection"] = {file: "Obstacle_Detection_c.html",line:75,type:"fcn"};
this.def["DAQ_In"] = {file: "Obstacle_Detection_types_h.html",line:31,type:"type"};
this.def["Obstacle_Detection_Out"] = {file: "Obstacle_Detection_types_h.html",line:44,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["Obstacle_Detection_c.html"] = "../Obstacle_Detection.c";
	this.html2Root["Obstacle_Detection_c.html"] = "Obstacle_Detection_c.html";
	this.html2SrcPath["Obstacle_Detection_h.html"] = "../Obstacle_Detection.h";
	this.html2Root["Obstacle_Detection_h.html"] = "Obstacle_Detection_h.html";
	this.html2SrcPath["Obstacle_Detection_private_h.html"] = "../Obstacle_Detection_private.h";
	this.html2Root["Obstacle_Detection_private_h.html"] = "Obstacle_Detection_private_h.html";
	this.html2SrcPath["Obstacle_Detection_types_h.html"] = "../Obstacle_Detection_types.h";
	this.html2Root["Obstacle_Detection_types_h.html"] = "Obstacle_Detection_types_h.html";
...
var fileList = [
"Obstacle_Detection_c.html","Obstacle_Detection_h.html","Obstacle_Detection_private_h.html","Obstacle_Detection_types_h.html","const_params_c.html","look1_binlgpw_c.html","look1_binlgpw_h.html","rtwtypes_h.html"];
