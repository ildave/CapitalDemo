...
void CommandLimits(const real_T *rtu_In1_Load_Center, const real_T
                   *rtu_In1_Load_Side, const real_T *rtu_In1_Load_Opposite,
                   const real_T *rtu_In1_Target_Steering, const real_T
                   *rtu_In1_Target_Driving, real_T *rty_Limited_TR_Left, real_T *
                   rty_Limited_TR_Right, real_T *rty_Limited_Speed_Backwards,
                   real_T *rty_Limited_Speed_Forward, B_CommandLimits_c_T
                   *localB)
{
  real_T Merge2;
  real_T Merge3;
  ...
  if (*rtu_In1_Target_Driving > 0.0) {
    ...
    Merge3 = look1_binlgpw(*rtu_In1_Load_Center, rtCP_LimitCharacteristicSpeed_e,
      rtCP_LimitCharacteristicSpeedF_, Merge2);
  ...
  if (*rtu_In1_Target_Steering > 0.0) {
    ...
    if (0.05 + *rtu_In1_Load_Side > *rtu_In1_Load_Opposite) {
      ...
      localB->Merge = look1_binlgpw(*rtu_In1_Load_Opposite,
        rtCP_Limitturnrate_bp01Data, rtCP_Limitturnrate_tableData, 1U);
      localB->Merge1 = 1.0;
      ...
      if (0.05 + *rtu_In1_Load_Side <= *rtu_In1_Load_Opposite) {
         ...
         *  Constant: '<S13>/Constant'
         */
        localB->Merge1 = look1_binlgpw(*rtu_In1_Load_Side,
          rtCP_Limitturnrate_bp01Data_j, rtCP_Limitturnrate_tableData_g, 2U);
    ...
    if (0.05 + *rtu_In1_Load_Side > *rtu_In1_Load_Opposite) {
      ...
      localB->Merge1 = look1_binlgpw(*rtu_In1_Load_Opposite,
        rtCP_Limitturnrate_bp01Data_e, rtCP_Limitturnrate_tableData_c, 1U);
      localB->Merge = -1.0;
      ...
      if (0.05 + *rtu_In1_Load_Side <= *rtu_In1_Load_Opposite) {
         ...
         *  Constant: '<S11>/Constant'
         */
        localB->Merge = look1_binlgpw(*rtu_In1_Load_Side,
          rtCP_Limitturnrate_bp01Data_m, rtCP_Limitturnrate_tableData_i, 2U);
