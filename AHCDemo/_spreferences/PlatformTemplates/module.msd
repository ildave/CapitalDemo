...
<solution name="AHCDemo.__spreferences.PlatformTemplates" uuid="~_PreferencesModule#AHCDemo.__spreferences.PlatformTemplates" moduleVersion="0" compileInMPS="true">
  <models>
