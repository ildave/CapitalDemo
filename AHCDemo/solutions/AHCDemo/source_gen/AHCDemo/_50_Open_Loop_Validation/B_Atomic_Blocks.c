...
;
...

    {
      {
        {
          at_Fuser_execute(&(___data->i_Fuser), HBA_HBA_Signal, HLC_HLC_Signal, Lever_Position, &(Fuser_High_Beam), &(Fuser_Low_Beam), &(Fuser_Park_Lights));
        }
;
      }
  ...
  {
    {
      ...
      __assertCondition = !(Knob_Position == OFF && Lever_Position != OPTICAL_HORN) || NOR3((*High_Beam),(*Low_Beam),(*Park_Lights));
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Lever_Position == C_Complex_Data_eLeverPosition__HEADLIGHT_AUTO && Knob_Position == C_Complex_Data_eKnobPosition__HEADLIGHT_AUTO && Dash_Illuminance >= 10000) || NOR3((*High_Beam),(*Low_Beam),(*Park_Lights));
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Lever_Position == C_Complex_Data_eLeverPosition__HEADLIGHT_AUTO && Knob_Position == C_Complex_Data_eKnobPosition__HEADLIGHT_AUTO && (Car_Detected == true || Vehicle_Speed < 36) && Dash_Illuminance < 10000) || (*Low_Beam) == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Lever_Position == LOW_BEAM && Knob_Position == HEADLIGHT_ON) || (*Low_Beam) == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Lever_Position == OPTICAL_HORN) || (*High_Beam) == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !((Car_Detected == false && Vehicle_Speed >= 36 && Dash_Illuminance < 10000 && Knob_Position == C_Complex_Data_eKnobPosition__HEADLIGHT_AUTO && Lever_Position == C_Complex_Data_eLeverPosition__HEADLIGHT_AUTO)) || (*High_Beam) == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Knob_Position == PARK_ON && Lever_Position != OPTICAL_HORN) || (*Park_Lights) == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = NAND3((*High_Beam),(*Low_Beam),(*Park_Lights));
      if (!__assertCondition) 
      {
        {
...
void at_Fuser_execute(at_Fuser_data_t *___id, eBeamState_t HBA_Signal, sLightState_t HLC_Signal, eLeverPosition_t Lever_Position, bool *High_Beam, bool *Low_Beam, bool *Park_Lights) 
{
...

  {
    {
      bool __assertCondition;
      __assertCondition = NAND(HLC_Signal.headlightOn,HLC_Signal.parkOn);
      if (!__assertCondition) 
      {
        {
...
*Park_Lights=relayPark;
  ...
  
  {
    {
      bool __assertCondition;
      __assertCondition = !(NOR(HLC_Signal.headlightOn,HLC_Signal.parkOn) && Lever_Position != OPTICAL_HORN) || NOR3((*High_Beam),(*Low_Beam),(*Park_Lights));
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(NOR(HLC_Signal.headlightOn,HLC_Signal.parkOn) && Lever_Position == C_Complex_Data_eLeverPosition__HEADLIGHT_AUTO) || NOR3((*High_Beam),(*Low_Beam),(*Park_Lights));
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(HLC_Signal.headlightOn == true && HBA_Signal == LOW && Lever_Position == C_Complex_Data_eLeverPosition__HEADLIGHT_AUTO) || (*Low_Beam) == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(HLC_Signal.headlightOn == true && Lever_Position == LOW_BEAM) || (*Low_Beam) == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(HLC_Signal.headlightOn == true && HBA_Signal == HIGH && Lever_Position == C_Complex_Data_eLeverPosition__HEADLIGHT_AUTO) || (*High_Beam) == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(HLC_Signal.headlightOn == true && Lever_Position == HIGH_BEAM) || (*High_Beam) == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(HLC_Signal.parkOn == true && Lever_Position != OPTICAL_HORN) || (*Park_Lights) == true;
      if (!__assertCondition) 
      {
        {
...
void at_HBA_execute(void *___nothing, bool Car_Detected, double Vehicle_Speed, eBeamState_t *HBA_Signal) 
{
  ...
  
  {
    {
      bool __assertCondition;
      __assertCondition = !((Car_Detected == true || Vehicle_Speed < 36)) || (*HBA_Signal) == LOW;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !((Car_Detected == false && Vehicle_Speed >= 36)) || (*HBA_Signal) == HIGH;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !((Vehicle_Speed >= (2 * 36)) && (Car_Detected != true)) || ((*HBA_Signal) != LOW);
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !((Car_Detected)) || (*HBA_Signal) != HIGH;
      if (!__assertCondition) 
      {
        {
...
void at_HLC_execute(void *___nothing, double Dash_Illuminance, eKnobPosition_t Knob_Position, sLightState_t *HLC_Signal) 
{
  ...
  
  {
    {
      bool __assertCondition;
      __assertCondition = !((Knob_Position == OFF)) || NOR((*HLC_Signal).headlightOn,(*HLC_Signal).parkOn);
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Knob_Position == C_Complex_Data_eKnobPosition__HEADLIGHT_AUTO && Dash_Illuminance >= 10000) || NOR((*HLC_Signal).headlightOn,(*HLC_Signal).parkOn);
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Knob_Position == C_Complex_Data_eKnobPosition__HEADLIGHT_AUTO && Dash_Illuminance < 10000) || (*HLC_Signal).headlightOn == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Knob_Position == HEADLIGHT_ON) || (*HLC_Signal).headlightOn == true;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Knob_Position == HEADLIGHT_ON) || (*HLC_Signal).headlightOn;
      if (!__assertCondition) 
      {
        {
    ...
    {
      bool __assertCondition;
      __assertCondition = !(Knob_Position == PARK_ON) || (*HLC_Signal).parkOn == true;
      if (!__assertCondition) 
      {
        {
