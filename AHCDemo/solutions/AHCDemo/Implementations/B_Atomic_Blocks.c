 ...
 * 
 * 
 * The inport(s)[Car_Detected, Dash_Illuminance, Knob_Position, Lever_Position, Vehicle_Speed] is/are defined in the structure at_ControlLogic_data_t in B_Atomic_Blocks.h
 * 
 * 
 * 
 * Data Properties
 ...
 * Constant Values
 * --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 * Name                                     Group Owner           Datatype    Value       Unit    Description                                                                                                                                                                                      
 * --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 * GlobalConstants.Threshold_Illuminance    E_Global_Constants    double      10000 lx    lx      This is the threshold illuminance value. Every illuminance value above this threshold is considered as daylight. Everything below is considered as dark.                                         
 * GlobalConstants.Threshold_Speed          E_Global_Constants    double      36 kmph     kmph    This is the threshold speed at which the automatic headlight can be switched to the high beam state. If the car is driving below this speed, the high beam can not be activated automatically    
 * --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 */
...
void at_ControlLogic_flattened_execute(at_ControlLogic_flattened_data_t *___id, bool Car_Detected, double Dash_Illuminance, eKnobPosition_t Knob_Position, eLeverPosition_t Lever_Position, double Vehicle_Speed, bool *High_Beam, bool *Low_Beam, bool *Park_Lights) 
{
   ...
   * post(1) AutoOff : Lever_Position == HEADLIGHT_AUTO && Knob_Position == HEADLIGHT_AUTO && Dash_Illuminance >= GlobalConstants.Threshold_Illuminance -> NOR3(High_Beam, Low_Beam, Park_Lights)
   * post(2) AutoLowBeam : Lever_Position == HEADLIGHT_AUTO && Knob_Position == HEADLIGHT_AUTO && (Car_Detected == true || Vehicle_Speed < GlobalConstants.Threshold_Speed) && Dash_Illuminance < GlobalConstants.Threshold_Illuminance -> Low_Beam == true
   ...
   * post(5) AutoHighBeam : (Car_Detected == false && Vehicle_Speed >= GlobalConstants.Threshold_Speed && Dash_Illuminance < GlobalConstants.Threshold_Illuminance && Knob_Position == HEADLIGHT_AUTO && Lever_Position == HEADLIGHT_AUTO) -> High_Beam == true
 ...
 * 
 * 
 * The inport(s)[Camera_Out, Dash_Sensor_Out, Knob_Position, Lever_Position, Vehicle_Speed] is/are defined in the structure at_Controller_data_t in B_Atomic_Blocks.h
 * 
 * 
 * 
 * Data Properties
...
void at_Controller_flattened_execute(at_Controller_flattened_data_t *___id, uint8_t Camera_Out[320][240], double Dash_Sensor_Out, eKnobPosition_t Knob_Position, eLeverPosition_t Lever_Position, double Vehicle_Speed, bool *High_Beam, bool *Low_Beam, bool *Park_Lights) 
{
  at_Controller_flattened_data_t *___data;
  /* 
   * Post conditions: 
 ...
 * 
 * 
 * The inport(s)[Car_Detected, Dash_Illuminance, Knob_Position, Lever_Position, Vehicle_Speed] is/are defined in the structure at_slk_ControlLogic_data_t in B_Atomic_Blocks.h
 * 
 * 
 * 
 * Data Properties
...
void at_Fuser_execute(void *___nothing, eBeamState_t HBA_Signal, sLightState_t HLC_Signal, eLeverPosition_t Lever_Position, bool *High_Beam, bool *Low_Beam, bool *Park_Lights) 
{
  ...
  /* 
   * Pre conditions: 
   * pre(8) IndependenceOfStates : NAND(HLC_Signal.headlightOn, HLC_Signal.parkOn)
   *  
   * Post conditions: 
   * post(0) FixedOff : NOR(HLC_Signal.headlightOn, HLC_Signal.parkOn) && Lever_Position != OPTICAL_HORN -> NOR3(High_Beam, Low_Beam, Park_Lights)
   * post(1) AutoOff : NOR(HLC_Signal.headlightOn, HLC_Signal.parkOn) && Lever_Position == HEADLIGHT_AUTO -> NOR3(High_Beam, Low_Beam, Park_Lights)
   * post(2) AutoLowBeam : HLC_Signal.headlightOn == true && HBA_Signal == LOW && Lever_Position == HEADLIGHT_AUTO -> Low_Beam == true
   * post(3) FixedLowBeam : HLC_Signal.headlightOn == true && Lever_Position == LOW_BEAM -> Low_Beam == true
   * post(4) OpticalHorn : Lever_Position == OPTICAL_HORN -> High_Beam == true
   * post(5) AutoHighBeam : HLC_Signal.headlightOn == true && HBA_Signal == HIGH && Lever_Position == HEADLIGHT_AUTO -> High_Beam == true
   * post(6) FixedHighBeam : HLC_Signal.headlightOn == true && Lever_Position == HIGH_BEAM -> High_Beam == true
   * post(7) ParkLights : HLC_Signal.parkOn == true && Lever_Position != OPTICAL_HORN -> Park_Lights == true
...
void at_HBA_execute(void *___nothing, bool Car_Detected, double Vehicle_Speed, eBeamState_t *HBA_Signal) 
{
  ...
  /* 
   * Post conditions: 
   * post(0) AutoLowBeam : (Car_Detected == true || Vehicle_Speed < GlobalConstants.Threshold_Speed) -> HBA_Signal == LOW
   * post(1) AutoHighBeam : (Car_Detected == false && Vehicle_Speed >= GlobalConstants.Threshold_Speed) -> HBA_Signal == HIGH
   */
...
void at_HLC_execute(void *___nothing, double Dash_Illuminance, eKnobPosition_t Knob_Position, sLightState_t *HLC_Signal) 
{
   ...
   * post(1) AutoOff : Knob_Position == HEADLIGHT_AUTO && Dash_Illuminance >= GlobalConstants.Threshold_Illuminance -> NOR(HLC_Signal.headlightOn, HLC_Signal.parkOn)
   * post(2) AutoLowBeam : Knob_Position == HEADLIGHT_AUTO && Dash_Illuminance < GlobalConstants.Threshold_Illuminance -> HLC_Signal.headlightOn == true
   * post(3) FixedLowBeam : Knob_Position == HEADLIGHT_ON -> HLC_Signal.headlightOn == true
   * post(4) AutoHighBeam : Knob_Position == HEADLIGHT_AUTO && Dash_Illuminance < GlobalConstants.Threshold_Illuminance -> HLC_Signal.headlightOn == true
...
/* 
 * atomicblock: at_slx_CarDetection
 * 
 * URL: http://127.0.0.1:63320/node?ref=r%3A92f02917-2939-4625-878a-0cf4bf3cdc0b%28AHCDemo._30_Implementation%29%2F6499409138675981307
 * 
 * 
 * 
 * 
 * The parameter/state variable(s) [Threshold_Grayscale, Threshold_Pixels] is/are defined in the structure at_slx_CarDetection_data_t in B_Atomic_Blocks.h
 * 
 * Data Properties
 * -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 * Name                   DD                     DD Owner             Access                        Usage        Datatype            Unit    Constraints                     Description                                                                                                                                
...
/* 
 * Execution function for block at_slx_CarDetection
 */
void at_slx_CarDetection_execute(at_slx_CarDetection_data_t *___id, uint8_t Camera_Out[240][320], bool *Car_Detected) 
{
}
 ...
 */
void at_CarDetection_execute(at_CarDetection_data_t *___id, uint8_t Camera_Out[320][240], bool *Car_Detected) 
{
